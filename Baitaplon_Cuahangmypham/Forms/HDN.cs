...
namespace BTL_Banmypham.Forms
{
    public partial class frmHoaDonNhap : Form
    {
        ...
        private void frmHoaDonNhap_Load(object sender, EventArgs e)
        {
            ...
            txtGiamgia.Text = "0";
            txtTongtien.Text = "0";
            Function.FillCombo("SELECT MaNCC, TenNCC FROM tblNhacungcap", cboManhacungcap, "MaNCC", "MaNCC");
            ...
            Function.FillCombo("SELECT SoHDN FROM tblChitiethoadonnhap", cboMahoadonnhap, "SoHDN", "SoHDN");
        ...
        private void UpdateGiaBan()
        {
            ...
            Function.runsql(sqlUpdateGiaBan);
        }
        ...
        private void LoadInfoHoaDon()
        {
            ...
            mskNgaynhap.Text = Function.ConvertDateTime(Function.GetFieldValues(str));
            ...
            cboManhacungcap.Text = Function.GetFieldValues(str);
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            ResetValues();
            txtMahoadonnhap.Text = Function.CreateKey("I");
            LoadDataGridViewChitietHDN();
        }
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (!Function.checkkey(sql))
            {
                ...
                sql = "INSERT INTO tblHoadonnhap(SoHDN, Ngaynhap, MaNV, MaNCC, Tongtien) VALUES (N'" + txtMahoadonnhap.Text.Trim() + "','" +
                        Function.ConvertDateTime(mskNgaynhap.Text.Trim()) + "',N'" + cboManhanvien.SelectedValue + "',N'" +
            ...
            tong = Convert.ToDouble(Function.GetFieldValues("SELECT Tongtien FROM tblHoadonnhap WHERE SoHDN = N'" + txtMahoadonnhap.Text + "'"));
        ...
        private void cboManhacungcap_TextChanged(object sender, EventArgs e)
        {
            ...
            txtTennhacungcap.Text = Function.GetFieldValues(str);
        ...
        {
            Function.FillCombo("SELECT SoHDN FROM tblHoadonnhap", cboMahoadonnhap, "SoHDN", "SoHDN");
            cboMahoadonnhap.SelectedIndex = -1;
        }

        private void HDN_FormClosing(object sender, FormClosingEventArgs e)
        {
